...
EventAttendanceRating.associate = function (models) {
  EventAttendeeRatings.belongsToMany(models.Event, { through: models.EventAttendance });
  EventAttendeeRatings.belongsToMany(models.Attendee, { through: models.EventAttendance });
};